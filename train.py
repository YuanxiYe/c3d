...
dataset = 'ucf101' # only ucf101, but optional in the future

if dataset == 'ucf101':
    num_classes = 101
else:
    print('We only implemented ucf datasets.')
...
modelName = 'C3D'	# only c3d, but optional in the future
...
def train_model(dataset=dataset, save_dir=save_dir, num_classes=num_classes, lr=lr,
    ...
    dummy_input = torch.rand(1, 3, 16, 112, 112)
    with SummaryWriter(comment='Net',log_dir=log_dir) as w:
